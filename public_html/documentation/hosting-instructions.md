...
- ssh into the server
    - For Mac and Linux: `ssh root@shayatorres.com`
    - For Windows: Set up a new PuTTY session
        ...
        - **Session**
            ...
            - Click Save
- create user
    - `useradd -m -s /bin/bash -g users -G sudo shayatorres`
    - replace shayatorres with your own
- create password
    - `passwd shayatorres`
- Move .ssh key file
    - `cp -r .ssh /home/shayatorres`
- change ownership of the .ssh directory
    - `cd /home/shayatorres`
    - `chown -R shayatorres:users .ssh/`


- Test Changes
    - `exit`
    - Mac/Linux: `ssh shayatorres@shayatorres.com`
    - Windows:
        - **Session**
            - Click pwp
            - Click Load
...
- reboot
    - `sudo reboot`
- ssh back in
- `ssh shayatorres@shayatorres.com`
...
- create a directory for your deployment
    - `sudo mkdir -p /var/www/shayatorres.com/html`
- fix permissions
    - `sudo chown -R $USER:users /var/www/shayatorres.com/html`
...
- `sudo vim /etc/nginx/sites-available/shayatorres.com`
...
server {
    ...
    root /var/www/shayatorres.com/html;
    index index.html index.htm index.nginx-debian.html;

    server_name shayatorres.com www.shayatorres.com;
...
- create a symlink to the sites-enabled directory
    - `sudo ln -s /etc/nginx/sites-available/shayatorres.com /etc/nginx/sites-enabled/`
...
- Create a new ssh key on your server in the .ssh directory
    - `ssh-keygen -t ed25519 -C  "github Deploy Key" -f /home/shayatorres/.ssh/github_deploy_key`
    - Don't enter a passphrase
        - hit enter twice
- Copy the public key into your authorized keys file
    - `cat /home/shayatorres/.ssh/github_deploy_key.pub >> /home/shayatorres/.ssh/authorized_keys`
...
- Copy the private key to your clipboard **(this is a very dangerous operation do not share this key with anyone )**
    ...
    - `cat /home/shayatorres/.ssh/github_deploy_key`
  ...
  deploy:
    ...
    steps:
      ...
      - name: Deploy to server
        run: |
         ssh-keyscan -H shayatorres.com >> ~/.ssh/known_hosts 
         scp -r ./dist/* gkephart@shayatorres.com:/var/www/shayatorres.com/html
```
